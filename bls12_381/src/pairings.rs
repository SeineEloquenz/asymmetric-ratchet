...
impl Gt {
    ...
    /// Returns the content of this group element.
    #[cfg(feature = "alloc")]
    pub fn content(&self) -> Vec<u64> {
        let mut result = Vec::new();
        result.extend(self.0.c0.c0.c0.0);
        result.extend(self.0.c0.c0.c1.0);
        result.extend(self.0.c0.c1.c0.0);
        result.extend(self.0.c0.c1.c1.0);
        result.extend(self.0.c0.c2.c0.0);
        result.extend(self.0.c0.c2.c1.0);
        result.extend(self.0.c1.c0.c0.0);
        result.extend(self.0.c1.c0.c1.0);
        result.extend(self.0.c1.c1.c0.0);
        result.extend(self.0.c1.c1.c1.0);
        result.extend(self.0.c1.c2.c0.0);
        result.extend(self.0.c1.c2.c1.0);
        result
    }
}
...
mod serde_support {
    ...
    impl Serialize for Gt {
            ...
            S: Serializer,
        {
            ...
            tup.serialize_element(&self.0.c0.c0.c0.0)?;
            tup.serialize_element(&self.0.c0.c0.c1.0)?;
            tup.serialize_element(&self.0.c0.c1.c0.0)?;
            tup.serialize_element(&self.0.c0.c1.c1.0)?;
            tup.serialize_element(&self.0.c0.c2.c0.0)?;
            tup.serialize_element(&self.0.c0.c2.c1.0)?;
            tup.serialize_element(&self.0.c1.c0.c0.0)?;
            tup.serialize_element(&self.0.c1.c0.c1.0)?;
            tup.serialize_element(&self.0.c1.c1.c0.0)?;
            tup.serialize_element(&self.0.c1.c1.c1.0)?;
            tup.serialize_element(&self.0.c1.c2.c0.0)?;
            tup.serialize_element(&self.0.c1.c2.c1.0)?;
            tup.end()
        }
    }
            ...
            D: Deserializer<'de>,
        {
            ...
            impl<'de> Visitor<'de> for GtVisitor {
                ...
                fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
                    formatter.write_str("a 576-byte bls12_381 Gt point")
                }

                fn visit_seq<A>(self, mut seq: A) -> Result<Gt, A::Error>
                where
                    A: serde::de::SeqAccess<'de>,
                {
                    let mut result = Gt::identity();
                    result.0.c0.c0.c0.0 = seq.next_element()?.unwrap();
                    result.0.c0.c0.c1.0 = seq.next_element()?.unwrap();
                    result.0.c0.c1.c0.0 = seq.next_element()?.unwrap();
                    result.0.c0.c1.c1.0 = seq.next_element()?.unwrap();
                    result.0.c0.c2.c0.0 = seq.next_element()?.unwrap();
                    result.0.c0.c2.c1.0 = seq.next_element()?.unwrap();
                    result.0.c1.c0.c0.0 = seq.next_element()?.unwrap();
                    result.0.c1.c0.c1.0 = seq.next_element()?.unwrap();
                    result.0.c1.c1.c0.0 = seq.next_element()?.unwrap();
                    result.0.c1.c1.c1.0 = seq.next_element()?.unwrap();
                    result.0.c1.c2.c0.0 = seq.next_element()?.unwrap();
                    result.0.c1.c2.c1.0 = seq.next_element()?.unwrap();
                    Ok(result)
                }
            }

            deserializer.deserialize_tuple(12, GtVisitor)
        }
    }
